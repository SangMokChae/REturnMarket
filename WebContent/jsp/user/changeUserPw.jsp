...
<head>
  ...
  <link rel="stylesheet" href="css/changeUserPw.css">
  <title>Change User Pw</title>
</head>
<body>
  <div class="screen">
    <div class="screenForm">
      <main class="main">
        ...
        <form action="changeUserPwAction.us" method="post" class="form-control changePwForm">
            <p class="change-title"><span class="user_id">${user_id }</span>님의 비밀번호를 변경해주세요.</p>
            ...
            <div class="changeForm-group__btn">
