  ...
  <div class="screen">
    <div class="screenForm">
      <main class="main">
        ...
        <form action="uploadQna.bo" method="post" class="uploadQna-form">
					<table class="table">
						<tr>
							<td class="col-2">글 제목</td>
							<td class="col-10">
								<input type="text" class="form-control" name="title" placeholder="글 제목을 적어주세요.">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="col-10"><textarea name="content" id="summernote"></textarea></td>
						</tr>
					</table>
          <div class="btn-group">
