...
<head>
	...
	<link rel="stylesheet" href="css/requesterInfo.css">
	...
	<div class="screen">
		<div class="screenForm">
			<main class="main">
				...
				<h1>상품이 ${bidBean.finalPrice }에 낙찰이 되었습니다.</h1>

				<div class="reqeusterInfo-container">
					<h1 class="infomation">구매자의 정보</h1>
					<h4 class="infomation__sub">연락처를 확인하시고, 직거래를 실행하시기 바랍니다.</h4>
					<p class="requester-info"><span>구매자 id : </span>${userBean.user_id }</p>
					<p class="requester-info"><span>구매자 연락처 : </span>${userBean.phone }</p>
					<p class="requester-info"><span>구매자 E-mail : </span>${userBean.email }</p>
					<p class="fin-word"><i class="far fa-star"></i> 좋은 직거래 부탁드립니다. <i class="far fa-star"></i></p>
					<a href="home.us" class="btn btn-primary">메인으로</a>
				</div>
			</main>
